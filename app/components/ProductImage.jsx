 ...
 * @property {ProductVariantFragment['image']} selectedVariantImage
 ...
 */
const ProductImage = ({selectedVariantImage, images}) => {
      ...
      <div className="space-y-4">
        ...
        >
          ...
          <div className="absolute inset-0 hidden md:flex items-center justify-between px-4 opacity-0 hover:opacity-100 transition-opacity">
            ...
            >
              <ChevronsLeft className="w-6 h-6 text-brand-navy" />
            </button>
            <button
              className="bg-white/90 rounded-full p-2 shadow-lg hover:bg-white transition-colors"
              onClick={(e) => {
            ...
            >
              <ChevronsRight className="w-6 h-6 text-brand-navy" />
            </button>
          </div>
          {/* Thumbnail Strip */}
        </div>
      ...
      {modalOpen && (
        <div className="w-full h-full fixed top-0 left-0 !my-0 inset-0 z-50 bg-black/95 backdrop-blur-sm">
          <div className="absolute inset-0 overflow-hidden">
            ...
            {/* Modal Image */}
            <div
              className="w-full h-full items-center flex justify-center p-0 md:p-8"
              onTouchStart={handleTouchStart}
              onTouchMove={handleTouchMove}
              onTouchEnd={handleTouchEnd}
            >
